...
import com.elanyudho.movrefapplication.data.remote.response.TopRatedMovieResponse
...
class TopRatedMovieMapper: BaseMapper<TopRatedMovieResponse, List<MovieItem>> {

    override fun mapToDomain(raw: TopRatedMovieResponse): List<MovieItem> {
    ...
    override fun mapToRaw(domain: List<MovieItem>): TopRatedMovieResponse {
